...
def main():
    parser = argparse.ArgumentParser(description="Aggregate benchmark results for research skill")
    parser.add_argument("workspace", type=Path, help="Path to workspace/iteration-N directory")
    parser.add_argument("--skill-name", default="research-workflow", help="Skill name")
